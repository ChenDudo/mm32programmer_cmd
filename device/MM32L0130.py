...
class MM32L0130(object):
    ...
    def __init__(self, xlink):
        super(MM32L0130, self).__init__()

        self.xlink = xlink

        self.flash = Flash(self.xlink, MM32L0130_flash_algo)
...
MM32L0130_flash_algo = {
    ...
    'instructions' : [
        ...
        0x000002F7, 0x00005AA5, 0x1FFE0000, 0x00000000
    ],
