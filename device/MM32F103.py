...
class MM32F103C8(object):
    ...
    def __init__(self, xlink):
        super(MM32F103C8, self).__init__()

        self.xlink = xlink

        self.flash = Flash(self.xlink,MM32F103C8_flash_algo)
...
class MM32F103CB(MM32F103C8):
    PAGE_SIZE = 1024 * 1
    SECT_SIZE = 1024 * 2
    CHIP_SIZE = 1024 * 256

    def __init__(self, xlink):
        super(MM32F103CB, self).__init__(xlink)

        self.flash = Flash(self.xlink, MM32F103C8_flash_algo)


MM32F103C8_flash_algo = {
